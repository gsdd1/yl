...
class Identify:
    ...
    def load_pt(self, weights):
        try:
            ...
            self.model = DetectMultiBackend(weights, device=self.device, dnn=self.dnn, data='', fp16=self.half)
...
if __name__ == '__main__':
    ...
    idp = Identify()
    idp.load_pt("runs/train/exp10/weights/best.pt")
    img = cv2.imread("data/images/F_0.jpg")
